...
function Projects() {
  ...
  const projects = [
    ...
    { 
      ...
      fullDesc: "Разработка имиджевого сайта с акцентом на типографику и качественные изображения. Внедрена система онлайн-бронирования столиков и интерактивная карта.",
    ...
    { 
      ...
      fullDesc: "Проектирование сложного интерфейса панели управления. Реализованы графики на Recharts, фильтрация данных в реальном времени и темная тема.",
    ...
    { 
      ...
      fullDesc: "Создание цифрового меню с категориями и поиском. Оптимизировано для мобильных устройств, чтобы клиенты могли делать заказ через QR-код.",
    ...
    { 
      ...
      fullDesc: "Сайт-галерея с эффектом 'до/после' для реализованных проектов. Использованы современные CSS-свойства для работы с изображениями высокого разрешения.",
    ...
    { 
      ...
      fullDesc: "B2B решение для автоматизации отчетности. Включает в себя личный кабинет клиента и систему уведомлений на базе Hooks.",
    ...
    { 
      ...
      fullDesc: "Полноценный каталог товаров с корзиной и оформлением заказа. Реализована сложная логика фильтров по характеристикам и цене.",
    ...
    { 
      ...
      fullDesc: "Веб-приложение, работающее как нативное. Поддержка Service Workers для работы без интернета и Push-уведомления.",
    ...
    { 
      ...
      fullDesc: "Креативный проект с использованием продвинутых техник верстки. Параллакс-скроллинг и шейповые анимации выделяют бренд на фоне конкурентов.",
    ...
    { 
      ...
      fullDesc: "Инструмент для выбора комплектации автомобиля. Пользователь может менять цвет и диски в реальном времени с мгновенным пересчетом цены.",
